                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <form onSubmit={onSubmit} action="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                                ...
                                <div className="mt-4">
                                    ...
                                    <TextInput id='project_due_date' name='due_date' type='date' value={data.due_date} className='mt-1 block w-full' isFocused={true} onChange={e => setData('due_date', e.target.value)} />
